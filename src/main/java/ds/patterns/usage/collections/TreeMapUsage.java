...
public class TreeMapUsage {
    ...
    public void sortTreeMapByValue2() {
        ...
        //TreeMap<String, Integer> sortedMap3 = sortByValues2(unSortedMap); // Throws an exception if entry is being used. Exception in thread "main" java.lang.ClassCastException: class ds.patterns.usage.collections.TreeMapUsage$2 cannot be cast to class java.util.Map (ds.patterns.usage.collections.TreeMapUsage$2 is in unnamed module of loader 'app'; java.util.Map is in module java.base of loader 'bootstrap')
    ...
    // Exception in thread "main" java.lang.ClassCastException: class ds.patterns.usage.collections.TreeMapUsage$2 cannot be cast to class java.util.Map (ds.patterns.usage.collections.TreeMapUsage$2 is in unnamed module of loader 'app'; java.util.Map is in module java.base of loader 'bootstrap')
