 ...
 *      If the pattern is not fully found, reset i to the next start index (0>1) and then again try to match the patter
 *      Runtime: O(m x n)
 *
 *
 ...
 *      you compute the has of the pattern only once. For the string to be matched, you compute the hash, when the hash does not match, shift the window,
 ...
 *
 *      Runtime
 *          O(mxn)    worst case     [By taking a good hgash function to reducing the chances spurious hits]
