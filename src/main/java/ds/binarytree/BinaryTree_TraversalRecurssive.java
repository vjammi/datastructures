...
public class BinaryTree_TraversalRecurssive {
    ...
    private void inorderTraversal() {
        ...
        System.out.println("\n Inorder List "+inorderList.toString());
    }
    ...
    private void postorderTraversal() {
        ...
        System.out.println("\n PostOrder List "+postorderList.toString());
    }
