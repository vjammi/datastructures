...
public class RunnableUsageWithInterrupts {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        interruptAThread_usingVolatileFlag();
        ...
        interruptAThread_usingTaskDotInterrupt();
    }

    private static void interruptAThread_usingVolatileFlag() throws InterruptedException {
    ...
    private static void interruptAThread_usingTaskDotInterrupt() throws InterruptedException {
