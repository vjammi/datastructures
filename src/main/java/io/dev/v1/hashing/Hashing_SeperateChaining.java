...
public class                          Hashing_SeperateChaining<Key, Value> {
    ...
    private final int M ;                   // 5 or 97      Number of chains. A prime number.
    private final Node[] arrayOfNodeChains;      // 0-4 or 0-96  Array of chains / list of Nodes

    private static class Node<Key, Value>   {
        private final Object key; // Declare key and val of type Object
        private Object val;
