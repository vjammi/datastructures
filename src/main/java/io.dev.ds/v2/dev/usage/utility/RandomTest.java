package dev.vjammi.ds.v2.dev.usage.utility;
...
public class RandomTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Random Num between 3 and 10: " + generateRandomIndex(3, 10));
    }

    private static int generateRandomIndex(int lo, int hi) {
